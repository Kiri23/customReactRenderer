...
console.log("=== Testing JSX LaTeX Renderer (Simple) ===\n");
...
try {
  ...
  // Save to file
  fs.writeFileSync("output-jsx-simple.tex", latexOutput);
  console.log("\n✅ LaTeX saved to: output-jsx-simple.tex");
  console.log(
    "📄 File size:",
    fs.statSync("output-jsx-simple.tex").size,
    "bytes",
  );
} catch (error) {
